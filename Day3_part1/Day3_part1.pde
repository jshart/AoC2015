...
String filebase = new String("C:\\Users\\jsh27\\OneDrive\\Documents\\GitHub\\AoC2015\\Day3_part1\\data\\mydata");
...
void setup() {
  ...
  println("min:"+minX.value+","+minY.value+" max:"+maxX.value+","+maxY.value);
